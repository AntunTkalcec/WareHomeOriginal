...
[GitHub](https://guides.github.com/features/mastering-markdown/), GitHub Classroom, .NET (Visual Studio), SourceTree, MSSQL, SSMS, MS Office 365, HTML Help Workshop, Draw.io, Visual Paradigm
